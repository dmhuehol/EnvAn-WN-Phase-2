%%TvZprint
    ...
    %an input date and a data structure, with plot settings necessary to
    %emphasize the lower part of the atmosphere and have good aesthetics
    %for printing.
    %
...
function [foundit] = TvZprint(y,m,d,t,sounding)
...
plot(geotemp,geoheightvector,freezingyg,freezingxg,'r','LineWidth',3); %Tvz
